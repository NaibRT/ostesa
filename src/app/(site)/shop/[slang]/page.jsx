...
import { faPlus, faMinus, faStarHalf } from "@fortawesome/free-solid-svg-icons";
...
async function ShopDetail({
  ...
  console.log("params",slang.split("_")[1])

 const {data, error, isLoading} = await getProduct(slang.split("_")[1])

  return (
    <>
      {/* Breadcrumb Start */}
      <Breadcrumb data={['Home','Shop','Shop Detail']}/>
      {/* Breadcrumb End */}
        ...
        <div className="row px-xl-5">
          ...
          <div className="col-lg-7 h-auto mb-30">
            <div className="h-100 bg-light p-30">
              ...
              {/* <del><h3 className="font-weight-semi-bold mb-4 text-danger">{data?.price}</h3></del> */}
              ...
              <div className="d-flex align-items-center mb-4 pt-2">
                ...
                >
                  <div className="input-group-btn">
                    ...
                    <FontAwesomeIcon icon={faMinus} className="text-white mr-1"/>
